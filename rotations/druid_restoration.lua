...
{   
    ...
    {spells.cenarionWard, 'player.hasTalent(1, 2) and kps.heal.defaultTank.hpIncoming < 0.9', kps.heal.defaultTank },
     -- Tank
    {spells.lifebloom, 'kps.heal.defaultTank.hp < 1 and kps.heal.defaultTank.myBuffDuration(spells.lifebloom) < 3 and not spell.lifebloom.lastCasted(6)', kps.heal.defaultTank},
